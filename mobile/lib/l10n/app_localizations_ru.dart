...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get pairingGateCodeWarning =>
      'Альтернативный способ. Без QR принтер может выходить в сеть на панели несколько минут — иногда до ~10. Для мгновенного подключения отсканируйте QR-код выше.';
